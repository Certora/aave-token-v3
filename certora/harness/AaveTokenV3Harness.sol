...
//   }
   ...
   function getDelegatedPowerByType(address user, GovernancePowerType delegationType) public returns (uint256) {
     DelegationAwareBalance memory userBalance = _balances[user];
